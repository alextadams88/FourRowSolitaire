...
public class Card extends JComponent
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5635757342696980119L;
    ...
    public boolean equals(Object other)
    {
    	if (other instanceof Card)
    	{
    		...
    		return (this.isHighlighted() == otherCard.isHighlighted() && this.getSource() == otherCard.getSource() && this.getNumber() == otherCard.getNumber() && this.getSuit() == otherCard.getSuit() && this.getColor() == otherCard.getColor()  && this.getFullNumber() == otherCard.getFullNumber() && this.isHighlighted() == otherCard.isHighlighted() && this.isFaceUp() == otherCard.isFaceUp());
    	}
    	return false;
    }
